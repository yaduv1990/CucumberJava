...
public class WeatherShopper {
	...
	String firefoxdriverpath =  "/CucumberJava/src/test/resources/drivers/chromedriver.exe";   // return driver folder path
	String temp=null;
	...
	public void user_reads_if_the_current_temperature_above(Integer int1) {
		...
		Loop:  
			if(n <34) {
				...
				System.out.println(" We will select sunscreen");
				break Loop;
			}
	}
